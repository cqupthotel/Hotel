...
//判断roomTypeService中的此类房间数量是否支持再添加此类房间
////////////////////////////////////////////////////////////////
		Map<String,Object> queryMap = new HashMap<String, Object>();
		queryMap.put("roomTypeId", room.getRoomTypeId());
		Integer k = roomService.getTotal(queryMap);
		System.out.println("共有此类房间"+k+"个");
		System.out.println("共允许有此类房间"+roomTypeService.find(room.getRoomTypeId()).getRoomNum()+"个");
		if(roomTypeService.find(room.getRoomTypeId()).getRoomNum() <= k) {
			ret.put("type", "error");
			ret.put("msg", "此类房间数已满,无法添加此类房间!");
			return ret;
		}
